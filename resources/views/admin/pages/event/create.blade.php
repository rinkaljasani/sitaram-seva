...
<div class="container">
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form id="frmAddUser" method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                {{-- name --}}
                ...
                {{-- benificial person --}}
                <div class="form-group">
                    <label for="benifical">benificalial person count{!!$mend_sign!!}</label>
                    <input type="number" class="form-control @error('benifical') is-invalid @enderror" id="benifical" name="benifical" value="{{ old('benifical') }}" placeholder="Enter benificalial " autocomplete="benifical" spellcheck="false" autocapitalize="sentences" tabindex="0" autofocus />
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="form-control @error('location') is-invalid @enderror" id="location" name="location" placeholder="Enter location" autocomplete="location" spellcheck="true"></textarea>
                 ...
                 {{-- Image --}}
                 <div class="form-group">
                    <label for="event_image">Upload Gallery event_Image (Select Multiple event_Images)</label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="event_image" name="event_image[]" tabindex="0" multiple/>
                        <label class="custom-file-label @error('event_image') is-invalid @enderror" for="customFile">Choose file</label>
                        @if ($errors->has('event_image'))
                            <span class="text-danger">
                                <strong class="form-text">{{ $errors->first('event_image') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
