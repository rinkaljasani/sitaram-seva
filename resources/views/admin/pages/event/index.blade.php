            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    @if (in_array('delete', $permissions))
                        <a href="{{ route('admin.events.destroy', 0) }}" name="del_select" id="del_select"
    ...
    <script>
        $(document).ready(function() {
            ...
            oTable = $('#galleryTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.events.listing') }}",
                    data: {
                        columnsDef: ['checkbox', 'name', 'description', 'number','image','created_at', 'active', 'action'],
                    },
                },
                columns: [
                    {   data: 'checkbox'    },
