    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="px-5 py-2"><a href="{{ route('admin.pages.edit',$page->custom_id) }}" class="btn btn-primary btn-block">Edit</a></div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="d-flex flex-column bd-highlight mb-3">
                            <div class="p-2 bd-highlight">Image</div>
                            <div class="px-2 mb-1 bd-highlight"><b><img src="{{ Storage::url($page->file) }}" height="150" width="auto"></b></div>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex flex-column bd-highlight mb-3">
                            <div class="p-2 bd-highlight">Title</div>
                            <div class="px-2 mb-1 bd-highlight"><b>{{ $page->title}}</b></div>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex flex-column bd-highlight mb-3">
                        <div class="p-2 bd-highlight">Description</div>
                        <div class="px-2  bd-highlight"><b>{{ $page->description ?: 'N/A'}}</b></div>
                    </div>
                </div>
            </div>
        </div>
