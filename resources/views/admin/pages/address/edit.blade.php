...
@push('breadcrumb')
    {!! Breadcrumbs::render('addresses_create') !!}
@endpush
...
<div class="container">
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form id="frmAddAddress" method="POST" action="{{ route('admin.addresses.update',$address->custom_id) }}">
            @csrf
            @method('PUT')
            {{-- State --}}
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" title="title" value="{{ old('title') != null ? old('title') : $address->title }}" placeholder="Enter title" autocomplete="title" autofocus />
                    @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" placeholder="Enter address" autocomplete="address" spellcheck="true">{{  $address->address }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="manager_name"  class="form-control @error('manager_name') is-invalid @enderror" id="manager_name" manager_name="manager_name" value="{{ old('manager_name') != null ? old('manager_name') : $address->manager_name }}" placeholder="Enter manager_name" autocomplete="manager_name" autofocus />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contact_no" id="contact_no" class="form-control @error('contact_no') is-invalid @enderror" id="contact_no" contact_no="contact_no" value="{{ old('contact_no') != null ? old('contact_no') : $address->contact_no }}" placeholder="Enter contact_no" autocomplete="contact_no" autofocus />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="alternative_contact_no"  class="form-control @error('alternative_contact_no') is-invalid @enderror" id="alternative_contact_no" alternative_contact_no="alternative_contact_no" value="{{ old('alternative_contact_no') != null ? old('alternative_contact_no') : $address->alternative_contact_no }}" placeholder="Enter alternative_contact_no" autocomplete="alternative_contact_no" autofocus />
    ...
    $("#frmAddAddress").validate({
        ...
        messages: {
            ...
            address: {
                ...
                minlength:"@lang('validation.min.string',['attribute'=>'address','min'=>3])",
            },
            manager_name: {
