                                ...
                                <tr class="role_row_{{ $roleId }}">
                                    ...
                                    <td>
                                        @if ( in_array('access', $allowed_permissions) )
                                            <input class="premision_check role_{{ $roleId }}" data-id="{{ $roleId }}"  data-error-container='#permission_error' name="roles[{{ strtolower($user_role->id) }}][permissions][]" type="checkbox" value="access" {{ in_array('access', $permissions) ? 'checked' : '' }} {{ $roleId == 1 ? 'checked disabled' : '' }}>
                                            @if ($user_role->id == 1)
